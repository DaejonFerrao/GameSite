            ...
            <div className="container mx-auto px-3 md:px-10">
               <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web 
                        ...
                        array of products converge into an interconnected overlay of experience
                        on your world.
                    </p>
               </div>
               ...
               <div className="border-hsla relative mb-7 h-96 w-full 
                 overflow-hidden rounded-md md:h-[65vh]">
                    ...
                    title={<>radi<b>n</b>t</>}
                    description='A new way to play and earn in the metaverse.'
                    isComingSoon={true}
                    />
               </div>
               ...
               <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <div className="bento-tilt_2">
                        <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                            ...
                            max-w-64 text-black">M<b>o</b>re co<b>m</b>ing s<b>o</b>on</h1>
